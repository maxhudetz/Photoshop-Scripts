 //make selected layer as tall as the canvas while maintining layer's proportion. -MH 9/18/18


    var maintainAspectRatio = true;// set to true to keep aspect ratio  
    if(app.documents.length>0)
        {  
            app.activeDocument.suspendHistory ('Fit Layer to Canvas HEIGHT', 'FitLayerToCanvas('+maintainAspectRatio+')');  
        }  
    function FitLayerToCanvas( keepAspect ){// keepAspect:Boolean - optional. Default to false  
        ...
        if( !keepAspect ){  
            ...
            //calculates aspect ratio of layer
            ...
            //says that if the new layer height is greater or equal to the document height,  
            // if (newHeight >= height) {  
